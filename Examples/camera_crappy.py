...
########################################### Creating blocks
	...
	#stream=modules.blocks.MeasureComediByStep(t0,instronSensor,labels=['t','m','N','voie3'])
	...
	#graph=modules.blocks.Grapher("dynamic",(0,1),(0,2),(0,3))
...
########################################### Creating links
	...
	link1=modules.links.Link(condition=condition_camera(n=10))
