...
class My_inout(crappy.inout.InOut):
  ...
  def get_data(self):
    ...
    It must return a list and the first value is always the time
    (as the number of seconds elapsed since 01/01/1970).
    It can return one or more other values, as long as it matches
    the number of labels in IOBlock
    """
