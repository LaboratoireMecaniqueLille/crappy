...
try:
    ...
    graph_disp = crappy.blocks.Grapher(('t(s)', 'dep(mm)'))
    graph_pos = crappy.blocks.Grapher(('t(s)', 'position'))
    graph_resistance = crappy.blocks.Grapher(('t_agilent(s)', 'resistance(ohm)'))
    graph_effort_deplacement = crappy.blocks.Grapher(('dep(mm)', 'F(N)'))
