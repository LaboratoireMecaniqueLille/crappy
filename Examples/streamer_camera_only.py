...
if __name__ == '__main__':
	...
	########################################### Creating blocks
		camera=crappy.blocks.StreamerCamera("Ximea",numdevice=0,freq=1,save=True,save_directory="/home/biotens/Bureau/ximea/",xoffset=0,yoffset=0,width=640,height=513)
