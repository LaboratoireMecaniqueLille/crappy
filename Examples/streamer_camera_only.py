...
if __name__ == '__main__':
	...
	########################################### Creating blocks
		camera=crappy.blocks.StreamerCamera("jai",numdevice=0,freq=1,save=False,save_directory="/home/biotens/Bureau/ximea/",xoffset=0,yoffset=0,width=1024,height=1024)
