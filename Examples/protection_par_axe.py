...
g1 = crappy.blocks.Generator([{'type':'protection','condition2':'F1>5','value1':10,
                                                   'condition1':'F1<-5','value2':-10}],
                                                   cmd_label='v1')

g2 = crappy.blocks.Generator([{'type':'protection','condition2':'F2>5','value1':10,
                                                   'condition1':'F2<-5','value2':-10}],
                                                   cmd_label='v2')

g3 = crappy.blocks.Generator([{'type':'protection','condition2':'F3>5','value1':10,
