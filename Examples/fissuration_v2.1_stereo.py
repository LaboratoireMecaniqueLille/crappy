...
try:
    ...
    camera = crappy2.blocks.StreamerCamera("Ximea", freq=None, numdevice=0, save=True,
                                           save_directory="/home/essais-2015-3/Bureau/Jerome/stereo/images_fissuration_13-05-16/cam1/")
    ...
    signalGenerator = crappy2.blocks.SignalGenerator(
        path=[{"waveform": "sinus", "time": 1000000, "phase": 0, "amplitude": 0.45, "offset": 0.55, "freq": 3}],
