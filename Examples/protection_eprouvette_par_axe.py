...
if __name__ == '__main__':
	...
	########################################### Creating objects
		...
		instronSensor=crappy.sensor.ComediSensor(channels=[1,2,3,4],gain=[-3749.3,-3749.3,-3198.9*1.18,-3749.3],offset=[0,0,0,0])
		t,F1=instronSensor.getData(0)
		t,F2=instronSensor.getData(1)
		t,F3=instronSensor.getData(2)
		t,F4=instronSensor.getData(3)
		instronSensor=crappy.sensor.ComediSensor(channels=[1,2,3,4],gain=[-3749.3,-3749.3,-3198.9*1.18,-3749.3],offset=[-F1,-F2,-F3,-F4])
	...
	########################################### Creating blocks
		...
		graph_effort=crappy.blocks.Grapher("dynamic",('t(s)','F2(N)'),('t(s)','F4(N)'),('t(s)','F3(N)'),('t(s)','F1(N)'))
