...
class condition_K(crappy.links.MetaCondition):
	...
	def evaluate(self,value):
		...
		if value['t_agilent(s)']> 60: ###################################################################################################################### delay before starting
			...
			Y = 1.99*alpha**(1/2.) - 0.41*alpha**(3/2.) + 18.7*alpha**(5/2.) - 38.48*alpha**(7/2) + 53.85*alpha**(9/2.)
...
########################################### Creating blocks
	...
	#print "112"
	camera=crappy.blocks.StreamerCamera("Ximea",freq=None,numdevice=0,save=True,save_directory="/home/essais-2015-3/Bureau/EssaiGS_26_05_16/images_fissuration_26_05_16/")
	...
	save_tension=crappy.blocks.Saver("/home/essais-2015-3/Bureau/EssaiGS_26_05_16/images_fissuration_26_05_16/tension_coeff.txt")
	...
	save_effort=crappy.blocks.Saver("/home/essais-2015-3/Bureau/EssaiGS_26_05_16/images_fissuration_26_05_16/t_dep_F.txt")
	#print "3"
...
########################################### Creating links
	...
	link1=crappy.links.Link(condition=condition_cycle_bool(n=10))
