...
########################################### Creating objects
	...
	sensor=crappy2.sensor.LabJackSensor(channels=[0, 1, 2], gain=[1, 1, 1], chan_range=10, mode="streamer", scanRate=4000, scansPerRead=1) # dist is multiplied by 2 to be correct
...
########################################### Creating blocks
	...
	compacter=crappy2.blocks.Compacter(4000)
	#compacter_effort=crappy2.blocks.Compacter(2000)
	save=crappy2.blocks.Saver("/home/corentin/Bureau/delete_2.txt")
	...
	#save_effort=crappy2.blocks.Saver("/home/corentin/Bureau/test_mesure_instron.txt")
