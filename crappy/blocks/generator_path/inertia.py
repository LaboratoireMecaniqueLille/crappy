...
class Inertia(Path):
  ...
  const (float), default is 30/pi:
    The value of K in the formula above. The default value is meant to send
    rpm with inertia in kgm² and torque in Nm. If sending rad/s, use const=1
