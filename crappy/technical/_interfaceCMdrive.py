...
class Interface(Frame):
	...
	self.motorCombo = Tix.ComboBox(sous_fra, editable=1, dropdown=1, variable=self.motorNameCombo) # create a combobox, it will contain names of ports 
	...
	self.advanceButton = Button(sous_fra2bis, text= "advance", command=self.advance, width=10) # create a advance button
