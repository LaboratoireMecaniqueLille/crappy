...
class Biotens(object):
    ...
    def mise_position(self):
        ...
        startposition = '\x52\x52\x52\xFF\x00' + _biotensSensor.convert_to_byte(10, 'B') + \
                        _biotensSensor.convert_to_byte(4, 'B') + _biotensSensor.convert_to_byte(0, 'i') + \
                        '\xAA\xAA\x50\x50\x50\xFF\x00' + _biotensSensor.convert_to_byte(10, 'B') + '\xAA\xAA'
    ...
    def initialisation(self):
        ...
        initposition = '\x52\x52\x52\xFF\x00' + _biotensSensor.convert_to_byte(38,
        ...
        initspeed = '\x52\x52\x52\xFF\x00' + _biotensSensor.convert_to_byte(40, 'B') + _biotensSensor.convert_to_byte(2,
                                                                                                                      'B') + _biotensSensor.convert_to_byte(
            -50, 'h') + '\xAA\xAA\x50\x50\x50\xFF\x00' + _biotensSensor.convert_to_byte(40, 'B') + '\xAA\xAA'
        inittorque = '\x52\x52\x52\xFF\x00' + _biotensSensor.convert_to_byte(41, 'B') + _biotensSensor.convert_to_byte(
            2, 'B') + _biotensSensor.convert_to_byte(1023,
                                                     'i') + '\xAA\xAA\x50\x50\x50\xFF\x00' + _biotensSensor.convert_to_byte(
            41, 'B') + '\xAA\xAA'
        toinit = '\x52\x52\x52\xFF\x00' + _biotensSensor.convert_to_byte(37, 'B') + _biotensSensor.convert_to_byte(2,
                                                                                                                   'B') + _biotensSensor.convert_to_byte(
