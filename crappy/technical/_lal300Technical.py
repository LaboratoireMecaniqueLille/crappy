...
##  @defgroup Lal300 Lal300
# @{

## @file _lal300Technical.py
...
class Lal300(motion.Motion):
    def __init__(self, param=p, port='/dev/ttyUSB1', baudrate=19200):
        ...
        # Appel de la sous-classe ActuatorLal300 avec les parametres situes dans le programme lal300Main.py
        self.actuator = Lal300Actuator(self.param, self.ser)
        # Appel de la sous-classe SensorLal300 avec les parametres situes dans le programme lal300Main.py
        self.sensor = Lal300Sensor(self.param, self.ser)
