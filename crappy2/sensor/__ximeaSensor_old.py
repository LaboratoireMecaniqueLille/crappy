...
class Ximea(cameraSensor.CameraSensor):
    ...
    def new(self, exposure=10000, width=2048, height=2048, xoffset=0, yoffset=0, gain=0):
        ...
        self.ximea = lib.VideoCapture(
            self.numdevice)  # open the ximea device Ximea devices start at 1100. 1100 => device 0, 1101 => device 1
        ...
        lib.set(self.ximea, xi.CAP_PROP_XI_DATA_FORMAT,
