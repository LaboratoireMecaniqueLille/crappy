...
##  @defgroup Lal300Actuator Lal300Actuator
# @{

## @file _lal300Actuator.py
...
class Lal300Actuator(motion.MotionActuator):
    def __init__(self, param=p, ser=None, port='/dev/ttyUSB1', baudrate=19200):
        ...
        #
        super(Lal300Actuator, self).__init__()
        self.param = param
        self.port = port
    ...
    def set_position(self, consigne):  # Envoi de la consigne de position au moteur
        ## @fn set_position()
        # @brief Send a position command to the motor
    ...
    def move_home(self):
        ## @fn move_home()
        # @brief Deplacement au point d'origine "Home"
    ...
    def reset(self):
        ## @fn reset()
        # @brief Reinitialisation des parametres du correcteur PID du moteur et defintion de l'origine moteur
        #
