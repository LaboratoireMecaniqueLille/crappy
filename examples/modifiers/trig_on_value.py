...
lets the value 1 pass, it ignores the value -1 that is sent half of the
time.

After starting this script, watch how the TrigOnValue Modifier filters the data
so that values are only sent when the signal is equal to 1. This demo ends
after 32 seconds. Click the stop button to end the demo early.
"""
...
if __name__ == '__main__':
  ...
  gen = crappy.blocks.Generator(
      ...
      # of 6 seconds and stopping after 5 cycles
      ({'type': 'Cyclic',
        'value1': 1,
        'value2': -1,
        'condition1': 'delay=3',
