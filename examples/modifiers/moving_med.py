...
median over a given number of previously received data points and sends it to
the downstream Block. It therefore preserves the data rate of the signal
flowing through the Link. This Modifier is useful for smoothing a noisy signal
while preserving its data rate.
...
wave and that of the filtering are the same, the median value returned by
