...
This Modifier is useful for plotting clearer graphs or correcting a sensor
...
12 seconds. Click the stop button to end the demo early.
"""
...
if __name__ == '__main__':
  ...
  gen = crappy.blocks.Generator(
      # Generating a ramp starting from 0 and increasing at 0.5 units/s
      # during 10 seconds
      ({'type': 'Ramp',
        'condition': 'delay=10',
