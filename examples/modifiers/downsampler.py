...
The DownSampler Modifier returns only the last received point every n data it
receives from its upstream Block. It therefore reduces the data rate on a given
Link. This Modifier is useful for reducing the data rate in a given Link.
...
Modifier is always close to 1 or -1, the peak of the sine wave.
