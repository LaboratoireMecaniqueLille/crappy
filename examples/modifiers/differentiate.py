...
depend on the derivative of a signal.
...
of the sine. This demo ends after 22 seconds. Click the stop button to end the
demo early.
"""
...
if __name__ == '__main__':
  ...
  # display. Before that, it is processed by the Diff Modifier, which adds the
