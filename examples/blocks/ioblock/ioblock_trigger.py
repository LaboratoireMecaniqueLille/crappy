...
any hardware to run, but necessitates the Python modules psutil and matplotlib
to be installed.
...
on it. Note that in addition, A StopButton Block allows stopping the script
properly without using CTRL+C by clicking on a button.
...
happens when you stop clicking on the button. To end this demo, click on the
