...
"""
This example demonstrates the use of the IOBlock Block when a trigger signal
controls data acquisition. It does not require any hardware, but requires the
psutil, pyqtgraph, and PyQt6 Python modules.
...
After starting this script, click the displayed button and notice how a value
is acquired and displayed on the Grapher after each click. Nothing happens when
you stop clicking on the button. To end this demo, click on the
