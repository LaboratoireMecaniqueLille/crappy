...
"""
This file is the MicroPython script to run on the microcontroller when testing
the ucontroller.py example. It blinks the GPIO 13 at a frequency received as a
command from the USB connection. It also returns the blink count and the
timestamp every 10 blinks over the USB connection. Note that the index of the
driven pin might need to be modified depending on the microcontroller to drive.
"""
