...
Actuator can move to reach the desired position. In this example, the motor can
move faster towards positive positions. This demonstrates how to adjust the
speed at runtime in position mode.
...
32 seconds. Click the stop button to end the demo early.
"""
...
if __name__ == '__main__':
  ...
  # This Generator provides the maximum speed at which the Actuator can move
