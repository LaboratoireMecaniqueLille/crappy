...
video-extensometry to emulate the extension measurement on the fake sample. Its
goal is to emulate a fake tensile test driven with Crappy and featuring
video-extensometry.
...
if __name__ == "__main__":
  ...
  # as an input, and outputs the extension and the stress to the VideoExtenso
  # Block
  ...
  # This VideoExtenso Block computes the extension using video-extensometry, on
  # an image stretched based on the extension values received from the
  # FakeMachine Block. The pair FakeMachine + VideoExtenso Blocks thus models
  # the behavior of an equivalent tensile test setup
