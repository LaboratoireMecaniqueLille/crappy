...
"""
This example extends the fake_test.py script with digital-image-correlation-
based video extensometry to emulate strain measurements on the fake sample.
Its goal is to emulate a tensile test driven with Crappy and featuring digital
image correlation.
...
if __name__ == "__main__":
  ...
  # as input and outputs the strain and force to the DICVE Block
  ...
  # This DICVE Block computes strain using image-correlation-based video
  # extensometry on an image stretched according to values from FakeMachine.
  # Together, the FakeMachine and DICVE Blocks model a tensile test setup
  dicve = crappy.blocks.DICVE(
      '',  # The name of Camera to open is ignored because image_generator is
      # given
      display_images=True,  # The displayer window follows the patches on the
      # acquired images
  ...
  # This Grapher Block plots the strain data it receives from the DICVE
  # Block
