...
"""
This example extends the fake_test.py script with digital image correlation to
emulate strain measurements on the fake sample. Its goal is to emulate a
tensile test driven with Crappy and featuring digital image correlation.
